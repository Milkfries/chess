...
public class AuthAccessTests {
    ...
    public void overwriteAuth() throws DataAccessException{
        ...
        AuthData accessAuth1 = authDAO.getAuth(testAuth1.authToken());
        AuthData accessAuth2 = authDAO.getAuth(replaceAuth.authToken());
        Assertions.assertEquals(accessAuth1, accessAuth2);
        Assertions.assertEquals(accessAuth1, replaceAuth);
    }
    @Test
