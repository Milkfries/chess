...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_LIGHT_GREEN = SET_BG_COLOR + "120m"; // Light Mint (White + Green highlight)
    public static final String SET_BG_COLOR_DARKER_GREEN  = SET_BG_COLOR + "36m";  
